...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $content = $name . ' оставил заявку на бронирования услуги  ' . $service . ' к барберу ' . $master . 'на '. $date . ' к '. $time .'. Его телефон: ' . $phone;

    // Первый параметр - кому отправляем письмо, второй - тема письма, третий - содержание
    $success = mail("callme@barberclub.com", 'Запрос на бронирование стрижки', $content);
